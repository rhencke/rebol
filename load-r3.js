...
var libr3_script = null
var load_r3_promiser = function() {
    return new Promise(function(resolve, reject) {
        var load_libr3 = function(n) {
            if (libr3_script) {document.body.removeChild(libr3_script)}
            libr3_script = document.createElement('script')
            libr3_script.onload = () => {
              resolve(n);
            };
            libr3_script.onerror = () => {
              reject();
            };
            script.src = url
